...
class ProductLists extends Component {
  ...
  getProducts(page, type) {
    ...
    if (type === 2 && page >= 1) {
      axios
        .get("../../../ebs-execution.php?type=5&page=" + page)
        .then(response => {
          console.log(response)
          if (response != undefined && response.data["products"]) {
            let npage = page + 1
  ...
  render() {
    ...
    return (
      <Layout>
        <SEO title="Professional Tools, Setup Essentials, Productivity and Wellness Products" />
              ...
              <div className="row align-items-center">
                <div className="col-lg-4 col-md-4">
                  <div className="woocommerce-result-count">
                    <p>
                      There are total of {this.state.productCount} products.
                    </p>
                  </div>
                </div>
